...
function init_admin_auth_assets()
{
    ...
    $CI->app_css->add('bootstrap-css' ,'assets/plugins/bootstrap.min.css' ,  $groupName);
    $CI->app_css->add('icons-css' ,'assets/plugins/icons.min.css' ,  $groupName);
    $CI->app_css->add('app-css' ,'assets/plugins/app.min.css' ,  $groupName);
}
...
function _init_admin_assets()
{
    ...
    // $CI->app_css->add('app-css' ,'assets/plugins/app.min.css' , 'admin', ['reset-css']);
    ...
    // $CI->app_css->add('bootstrap-css' ,'assets/plugins/bootstrap.min.css' , 'admin', ['reset-css']);
    // $CI->app_css->add('icons-css' ,'assets/plugins/icons.min.css' , 'admin', ['reset-css']);
